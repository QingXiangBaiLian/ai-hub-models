...
from qai_hub_models.models._shared.qwen3_5.model import (
    DEFAULT_CONTEXT_LENGTH,
    DEFAULT_SEQUENCE_LENGTH,
    Qwen3_5Base,
    Qwen3_5Base_AIMETOnnx,
    Qwen3_5Base_QNN,
)
...
NUM_LAYERS = 24
NUM_SPLITS = 2
NUM_LAYERS_PER_SPLIT = 24
HIDDEN_SIZE = 1024
NUM_KEY_VALUE_HEADS = 2
NUM_ATTN_HEADS = 8
HEAD_DIM = 256

# Layer types: every 4th layer is full_attention, rest are linear_attention
LAYER_TYPES = [
    "linear_attention",
    "linear_attention",
    "linear_attention",
...
class Qwen3_5_0_8B(Qwen3_5Base):
    ...
    def from_pretrained(
        ...
        """
        Load a pre-trained Qwen3.5-0.8B model via HuggingFace.
        ...
        -------
        model : Self
            The pre-trained Qwen3.5-0.8B model.
        """
...
class Qwen3_5_0_8B_AIMETOnnx(Qwen3_5Base_AIMETOnnx):
    ...
    def from_pretrained(
        ...
        _skip_quantsim_creation
            Internal parameter to skip quantsim creation. This helps export
            on platforms where aimet onnx is not available.
        use_dynamic_shapes
        ...
        -------
        model : Self
            The quantized Qwen3.5-0.8B model.
        """
...
class Qwen3_5_0_8B_QNN(Qwen3_5Base_QNN):
