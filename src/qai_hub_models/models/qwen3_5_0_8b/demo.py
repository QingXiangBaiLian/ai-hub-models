...
from qai_hub_models.models._shared.qwen3_5.model import END_TOKENS
from qai_hub_models.models.qwen3_5_0_8b import (
    MODEL_ID,
    FP_Model,
    Model,
    QNN_Model,
